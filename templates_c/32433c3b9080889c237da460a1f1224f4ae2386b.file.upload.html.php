<?php /* Smarty version Smarty-3.1.19, created on 2014-07-25 06:39:32
         compiled from "D:\DedeAMPZ\WebRoot\luo\myframe\view\Admin\upload.html" */ ?>
<?php /*%%SmartyHeaderCode:335653d1d364c401c4-82744238%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '32433c3b9080889c237da460a1f1224f4ae2386b' => 
    array (
      0 => 'D:\\DedeAMPZ\\WebRoot\\luo\\myframe\\view\\Admin\\upload.html',
      1 => 1406270371,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '335653d1d364c401c4-82744238',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_53d1d364e18a32_48141126',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53d1d364e18a32_48141126')) {function content_53d1d364e18a32_48141126($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_4">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-eyedropper">上传文件</span>
                    </div>
                    <div class="mws-panel-body">
                    	<form class="mws-form" method='post' enctype='multipart/form-data'  action="<?php echo @constant('SERVER');?>
admin.php?c=file&a=upImg_do">
                        	<div class="mws-form-inline">
                            	
                            	<div class="mws-form-row">
                                	<label>文件：</label>
                                	<div class="mws-form-item large">
                                    	<input type="file" name="photo" class="mws-textinput" />
                                    </div>
                                </div>
                            	<div class="mws-form-row">
                                	<label>文件名：</label>
                                	<div class="mws-form-item large">
                                    	<input type="text" name="filename" class="mws-autocomplete mws-textinput" />
                                    </div>
                                </div>
                                
                            </div>
                            <div class="mws-button-row">
								<input class="mws-button red" type="submit" value="Submit">
							</div>
                        </form>
                    </div>    	
                </div>
